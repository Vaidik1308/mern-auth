...
const NavigationLinks = () => {
  return (
    <>
        ...
        <Link to={"/profile"}>
            <img className='rounded-full size-10 object-cover' src="https://images.unsplash.com/photo-1511367461989-f85a21fda167?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cHJvZmlsZXxlbnwwfHwwfHx8MA%3D%3D" alt="" />
        </Link>
    </>
  )
}
